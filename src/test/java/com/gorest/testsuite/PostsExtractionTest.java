...
public class PostsExtractionTest {
    ...
    @Test
    public void test006() {
        List<?> allRecords = response.extract().path("findAll{it.user_id == 7018184}.title");
        System.out.println("------------------StartingTest---------------------------");
    ...
    @Test
    public void test007() {
        List<?> allRecordWhoseID = response.extract().path("findAll{it.id==140298}.body");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("UserId Record Body : " + allRecordWhoseID);
        System.out.println("------------------End of Test---------------------------");
    }
}
